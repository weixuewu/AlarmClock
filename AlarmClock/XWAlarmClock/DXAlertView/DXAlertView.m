   ...
   rightButtonTitle:(NSString *)rigthTitle
{
    if (self = [super init]) {
        ...
        self.alertContentLabel = [[UILabel alloc] initWithFrame:CGRectMake((kAlertWidth - contentLabelWidth) * 0.5, kTitleYOffset + 4, contentLabelWidth, 60)];
        ...
        self.alertContentLabel.font = [UIFont boldSystemFontOfSize:18];
...
#define kButtonBottomOffset 10.0f
        ...
        //kColor_Dark_Brow
        //[UIColor colorWithRed:87.0/255.0 green:135.0/255.0 blue:173.0/255.0 alpha:1]
        [self.rightBtn setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithRed:0.35 green:0.20 blue:0.21 alpha:0.9]] forState:UIControlStateNormal];
        //kColor_Pink
        //[UIColor colorWithRed:227.0/255.0 green:100.0/255.0 blue:83.0/255.0 alpha:1]
